  ...
  return (
    <QuartiereLandingPage
      ...
      marketText={[
        ...
        "Sul fronte dei prezzi, l'Arenella si posiziona generalmente al di sotto del Vomero centrale, pur restando in una fascia medio-alta per gli standard cittadini: [PLACEHOLDER: inserire fascia €/mq aggiornata, distinta per stato dell'immobile]. Le differenze principali dipendono dalla vicinanza al confine con il Vomero vero e proprio — dove i valori si avvicinano a quelli della zona più centrale — e dalla presenza di vista, piano alto o spazi esterni, elementi che nella collina napoletana incidono più che altrove sul prezzo finale.",
      ...
      faq={[
        {
          ...
          a: "Generalmente meno del Vomero centrale ma comunque in una fascia medio-alta per Napoli. [PLACEHOLDER: inserire fascia di prezzo €/mq aggiornata]. Richiedi una valutazione gratuita per una stima precisa basata su vendite comparabili reali della zona.",
        },
        {
        ...
        },
        {
          ...
          a: "Dipende da prezzo richiesto, documentazione e marketing dell'immobile. [PLACEHOLDER: inserire tempo medio di vendita verificato]. Un immobile con carte in regola e prezzo in linea con il mercato si vende generalmente più rapidamente.",
        },
        {
