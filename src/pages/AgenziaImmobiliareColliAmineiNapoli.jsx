  ...
  return (
    <QuartiereLandingPage
      ...
      marketText={[
        ...
        "Sul fronte dei prezzi, i Colli Aminei si collocano in una fascia media per Napoli, generalmente più accessibile rispetto a Vomero, Chiaia e Posillipo: [PLACEHOLDER: inserire fascia €/mq aggiornata, distinta per stato dell'immobile e vicinanza alla stazione metro]. La vicinanza alla fermata della metropolitana e ai poli ospedalieri sono tra i fattori che incidono maggiormente sulla domanda e quindi sul valore degli immobili della zona.",
      ...
      faq={[
        {
          ...
          a: "I Colli Aminei sono generalmente più accessibili rispetto a Vomero, Chiaia e Posillipo. [PLACEHOLDER: inserire fascia di prezzo €/mq aggiornata]. Richiedi una valutazione gratuita per una stima precisa basata su vendite comparabili reali.",
        },
        {
        ...
        },
        {
          ...
          a: "Dipende da prezzo richiesto, documentazione e marketing dell'immobile. [PLACEHOLDER: inserire tempo medio di vendita verificato]. La vicinanza alla metro tende a facilitare la vendita rispetto a zone meno servite.",
        },
        {
