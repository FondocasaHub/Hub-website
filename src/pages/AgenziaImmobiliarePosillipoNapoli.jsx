  ...
  return (
    <QuartiereLandingPage
      ...
      marketText={[
        ...
        "Sul fronte dei prezzi, Posillipo è tra le zone più costose non solo di Napoli ma dell'intera Campania: sul venduto che seguiamo il valore ricorrente si colloca tra 4.500 e 5.100 €/mq a seconda della zona, con punte oltre i 6.900. Le ville con vista mare diretta si trattano fuori mercato, caso per caso. La presenza di vista mare, il livello di privacy e le dimensioni del giardino o della terrazza sono i fattori che incidono maggiormente sul valore finale, spesso più della semplice metratura interna.",
      ...
      priceTable={[
        { via: "Marechiaro", tipico: "5.100 €/mq", massimo: "6.700 €/mq" },
        { via: "Via Orazio", tipico: "4.992 €/mq", massimo: "6.900 €/mq" },
        { via: "Via Posillipo", tipico: "4.500 €/mq", massimo: "5.900 €/mq" },
      ]}
      faq={[
        {
          q: "Quanto vale una villa o un appartamento a Posillipo?",
          a: "Posillipo è tra le zone più costose di Napoli e il valore cambia molto in base a vista mare, giardino e tipologia. Sul venduto che seguiamo, a Marechiaro circa il 70% delle compravendite si chiude intorno a 5.100 €/mq con punte fino a 6.700, in via Orazio intorno a 4.992 €/mq con punte fino a 6.900, in via Posillipo intorno a 4.500 €/mq con punte fino a 5.900. Le ville con affaccio diretto sul mare si trattano fuori mercato, caso per caso. Richiedi una valutazione gratuita e riservata.",
        },
        {
